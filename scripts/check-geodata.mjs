...
const endpoints = [
  ...
  `https://ws.geonorge.no/stedsnavn/v1/punkt?ost=${coordinates.longitude}&nord=${coordinates.latitude}&koordsys=4258&radius=1000`,
  `https://ws.geonorge.no/hoydedata/v1/punkt?x=${coordinates.longitude}&y=${coordinates.latitude}&koordsys=4258`,
];
